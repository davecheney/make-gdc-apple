...
# -------------------------------
VPATH=/Users/dave/devel/make-gdc-apple/work/gcc-5465

build_alias=i686-apple-darwin9
...
srcdir = /Users/dave/devel/make-gdc-apple/work/gcc-5465
...
gcc_version_trigger = /Users/dave/devel/make-gdc-apple/work/gcc-5465/gcc/version.c
gcc_version = 4.0.1

# The gcc driver likes to know the arguments it was configured with.
TOPLEVEL_CONFIGURE_ARGUMENTS=/Users/dave/devel/make-gdc-apple/work/gcc-5465/configure --build=i686-apple-darwin9 --with-arch=nocona --with-tune=generic --host=i686-apple-darwin9 --target=i686-apple-darwin9 --prefix=ESTROOT --enable-languages=d --with-system-zlib --disable-nls --disable-multilib

gxx_include_dir = ${prefix}/include/c++/4.0.1
libstdcxx_incdir = c++/4.0.1

tooldir = ${exec_prefix}/i686-apple-darwin9
build_tooldir = ${exec_prefix}/i686-apple-darwin9
...
REALLY_SET_LIB_PATH = \
  $(RPATH_ENVVAR)=/Users/dave/devel/make-gdc-apple/gcc; export $(RPATH_ENVVAR); \
  $(RPATH_ENVVAR)=`echo "$(HOST_LIB_PATH):$(TARGET_LIB_PATH):$$$(RPATH_ENVVAR)" | sed 's,::*,:,g;s,^:*,,;s,:*$$,,'`; export $(RPATH_ENVVAR);

# This is the list of directories to be built for the build system.
BUILD_CONFIGDIRS = libiberty
# Build programs are put under this directory.
BUILD_SUBDIR = build-i686-apple-darwin9
# This is set by the configure script to the arguments to use when configuring
# directories built for the build system.
BUILD_CONFIGARGS = --cache-file=../config.cache --build=i686-apple-darwin9 --host=i686-apple-darwin9 --target=i686-apple-darwin9 --with-arch=nocona --with-tune=generic --prefix=ESTROOT --with-system-zlib --disable-nls --disable-multilib --with-gcc-version-trigger=/Users/dave/devel/make-gdc-apple/work/gcc-5465/gcc/version.c --enable-languages=c,d --program-transform-name='s,y,y,'
...
HOST_CONFIGARGS = --cache-file=./config.cache --build=i686-apple-darwin9 --host=i686-apple-darwin9 --target=i686-apple-darwin9  --with-arch=nocona --with-tune=generic --prefix=ESTROOT --with-system-zlib --disable-nls --disable-multilib --with-gcc-version-trigger=/Users/dave/devel/make-gdc-apple/work/gcc-5465/gcc/version.c --enable-languages=c,d --program-transform-name='s,y,y,'
# This is the list of variables to export in the environment when
...
HOST_EXPORTS = \
	...
	SET_GCC_LIB_PATH_CMD="$(RPATH_ENVVAR)=/Users/dave/devel/make-gdc-apple/gcc; export $(RPATH_ENVVAR);"; export SET_GCC_LIB_PATH_CMD; \
	$(RPATH_ENVVAR)=/Users/dave/devel/make-gdc-apple/gcc; export $(RPATH_ENVVAR);
...
TARGET_CONFIGDIRS =  libiberty libphobos
# Target libraries are put under this directory:
TARGET_SUBDIR = i686-apple-darwin9
# This is set by the configure script to the arguments to use when configuring
# directories built for the target.
TARGET_CONFIGARGS = --cache-file=./config.cache --host=i686-apple-darwin9 --build=i686-apple-darwin9 --with-arch=nocona --with-tune=generic --prefix=ESTROOT --with-system-zlib --disable-nls --disable-multilib --with-gcc-version-trigger=/Users/dave/devel/make-gdc-apple/work/gcc-5465/gcc/version.c --enable-languages=c,d --program-transform-name='s,y,y,'
# This is the list of variables to export in the environment when
# configuring subdirectories for the host system.
...
CONFIGURED_LIPO_FOR_TARGET=lipo
...
RANLIB_FOR_TARGET=$(USUAL_RANLIB_FOR_TARGET) -c
...
CONFIGURED_STRIP_FOR_TARGET=strip
